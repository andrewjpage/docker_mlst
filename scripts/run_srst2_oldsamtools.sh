...
# ./run_srst2.sh /mnt/data/coverage /data/srst2 compose_srst2_oldsamtools Salmonella_enterica

if [ $# -ne 4 ]
then
    echo "Usage: `basename $0` host_base output_directory docker_hash"
    echo "Example: ./run_srst2.sh /mnt/data/coverage /data/srst2 compose_srst2_oldsamtools Salmonella_enterica"
...
SOFTWARE_NAME=srst2_oldsamtools
